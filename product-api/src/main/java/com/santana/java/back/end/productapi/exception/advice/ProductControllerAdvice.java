package com.santana.java.back.end.productapi.exception.advice;

import com.santana.java.back.end.productapi.dto.ErrorDTO;
...
@ControllerAdvice(basePackages = "com.santana.java.back.end.productapi.controller")
